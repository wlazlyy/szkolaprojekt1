Do czego służy ta aplikacja (cel)?

Ta aplikacja pozwala nam szybko wykonywać podstawowe działania matematyczne, takie jak dodawanie, odejmowanie, mnożenie, dzielenie i potęgowanie.

Jak to działa (zasada)?

Działanie aplikacji jest proste. Wprowadzamy dwie liczby, wybieramy operację, którą chcemy wykonać (na przykład dodawanie lub mnożenie), a aplikacja oblicza wynik i nam go pokazuje.
